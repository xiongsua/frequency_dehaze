...
class backward_D():
    ...
    def backward_D_basic(self,netD, real, fake):
        ...
        """
        netD = define_D(3, 3, which_model_netD='basic',n_layers_D=3, norm='batch', use_sigmoid=False, init_type='normal', gpu_ids=[])
        # Real
        netD.cuda()
        pred_real = netD(real)
        # loss_D_real = self.Base.Base.criterionGAN(pred_real, True)
        # loss = Base.Base(args)
